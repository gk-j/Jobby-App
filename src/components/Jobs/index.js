...
class Jobs extends Component {
  state = {
    ...
    radioInput: '',
    searchInput: '',
    apiStatus: apiProfileStatusConstants.initial,
  ...
  onGetProfileDetails = async () => {
    this.setState({apiStatus: apiProfileStatusConstants.inProgress})
    ...
    if (responseProfile.ok === true) {
      ...
      this.setState({
        ...
        apiStatus: apiProfileStatusConstants.success,
      })
    } else {
      this.setState({apiStatus: apiProfileStatusConstants.failure})
    }
  }
